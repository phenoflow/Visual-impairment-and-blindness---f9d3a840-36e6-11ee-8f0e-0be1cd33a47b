...
steps:
  ...
  visual-impairment-including-visual-impairment-and-blindness-blindness---secondary:
    run: visual-impairment-including-visual-impairment-and-blindness-blindness---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: visual-impairment-including-visual-impairment-and-blindness-blindness---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
